    ...
    <section className="relative overflow-hidden border-b border-white/5">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 px-6 py-20 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:py-28">
        <div>
          ...
          <h1 className="mt-6 max-w-3xl text-5xl font-semibold leading-[1.04] tracking-[-0.04em] text-white md:text-7xl">
        ...
        <div className="ai-float relative mx-auto w-full max-w-xl">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#10121a]/90 p-4 shadow-2xl shadow-black/50 backdrop-blur-xl sm:p-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <span className="rounded-full border border-white/10 px-3 py-1 text-xs text-slate-500">Brand mode</span>
            </div>
            ...
            <div className="space-y-5 py-6">
              ...
              <div className="flex gap-3">
                ...
                <div className="min-w-0 flex-1 rounded-2xl rounded-tl-md border border-white/10 bg-white/[0.035] p-4">
