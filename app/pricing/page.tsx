      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
            Start free, generate campaigns faster, and upgrade when your
            business needs more.
          </p>
        </div>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Best for testing Marketa AI and trying your first campaigns.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Ideal for business owners posting promotions every week.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Built for brands and businesses running campaigns often.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Best for agencies, teams, and heavy campaign generation.
              </p>
            </div>
          </div>
        </div>
